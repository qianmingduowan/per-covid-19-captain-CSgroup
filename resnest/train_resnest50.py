...
def main(epoch_all,bs=80,tensorboard_path='./tensorboard',output_dir = 'output-resnest50_q'): 
    ...
    # model.load_state_dict(torch.load('resnest50-528c19ca.pth'))
