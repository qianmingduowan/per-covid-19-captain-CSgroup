...
def main(epoch_all,bs=80,tensorboard_path='./tensorboard',output_dir = 'output-resnest50_q'): 
    ...
    if args.validation_part == '0':
        ...
        output_dir = 'output_resnest101_0'
    if args.validation_part == '1':
        ...
        output_dir = 'output_resnest101_1'
    if args.validation_part == '2':
        ...
        output_dir = 'output_resnest101_2'
    if args.validation_part == '3':
        ...
        output_dir = 'output_resnest101_3'
    if args.validation_part == '4':
        ...
        output_dir = 'output_resnest101_4'
    ...
    # model.load_state_dict(torch.load('/data/jyx/resnest101.pth'))
